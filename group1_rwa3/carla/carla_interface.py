...
class CarlaInterface:
    ...
    def connect(self) -> bool:
        ...
        try:
            ...
            if town04_available:
                print("✓ Town04 (highway map) is available")
                if 'Town04' in current_map_name:
                    print("✓ Already on Town04, skipping reload")
        ...
        try:
            ...
            if relative_d > self.config.lane_width / 2:
                ...
                if left_lane and left_lane.lane_type == carla.LaneType.Driving:
                    ...
                    print("  Warning: Left lane not available for traffic spawn")
                    return None
                ...
                if right_lane and right_lane.lane_type == carla.LaneType.Driving:
                    ...
                    print("  Warning: Right lane not available for traffic spawn")
                    return None
